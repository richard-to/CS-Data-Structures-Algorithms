...
3. mkdir bin
4. javac -sourcepath src src/assignment3java -d bin
5. java bin/assignment3
6. There is a static variable in Assignment3.java that controls the number of checkout counters.
